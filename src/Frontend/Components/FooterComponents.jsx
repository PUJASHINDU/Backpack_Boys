...
const LINKS = [
  {
    title: "Product",
    items: ["Backpaks", "Backpaks Cassual", "Backpaks Style"],
  },
  {
    title: "Service",
    items: ["Shopping", "Payment",],
  },
  {
    title: "Brand",
    items: ["Fjallraven", "Eiger", "Patagonia", "The North Face", "Deuter"],
  },
];
    ...
    <footer className="relative w-full bg-gray-100 mt-36 font-poppins">
      <div className="mx-auto w-full max-w-7xl px-8 ">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-200 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center  text-customBlue font-bold font-poppins md:mb-0"
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">Backpaks Boys</a>. All
            Rights Reserved.
          </Typography>
